  ...
  it('keeps stable timing fields and removes private URL values', () => {
    ...
    const timing = {
      ...
      resources: [
        ...
        {
          name: 'https://staging.example.test/stage-4/overrides/private-file-id?job_id=private',
          initiatorType: 'fetch',
          startTime: 9,
          responseStart: 18,
          responseEnd: 19,
    ...
    assert.deepEqual(result, {
      ...
      resources: [
        ...
        {
          path: '/stage-4/overrides/:file_id',
          initiator_type: 'fetch',
          start_ms: 9,
          response_start_ms: 18,
          response_end_ms: 19,
          transfer_size_bytes: 300,
          encoded_body_size_bytes: 200,
          decoded_body_size_bytes: 400,
          delivery_type: null,
        },
        {
