...
from src.observability.events import FILE_ID_PATTERN, REQUEST_ID_PATTERN, ClientEventName
...
class ClientEventRequest(BaseModel):
    ...
    server_request_id: str | None = Field(default=None, pattern=REQUEST_ID_PATTERN)
