...
/** Canonical upload/workflow id shape generated by the backend. */
const FILE_ID_PATTERN = /^[a-f0-9]{32}$/;

/**
 * Check file_id has the canonical upload/workflow id shape.
 * @param {string|null|undefined} id - The file ID to check
 * @returns {boolean} True when ID is a lowercase 32-character hex string
 */
export const isValidFileId = (id) => typeof id === 'string' && FILE_ID_PATTERN.test(id);
